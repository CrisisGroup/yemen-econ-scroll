var config = {
    style: 'mapbox://styles/daltonwb/ckz4lgl2j000u15nw088arfdg',
    ...
    chapters: [
        ...
        },
        {
            ...
            image: '',
            description: 'كما تظهر هذه الخريطة، فإنه بحلول حزيران/يونيو 2021 كان سعر دولار واحد في المناطق الخاضعة اسمياً للحكومة يتجاوز بكثير سعره في المناطق الواقعة تحت سيطرة الحوثيين، حيث ظل سعر الصرف مستقراً نسبيا&#1748;',
            location: {
              center: [47.803856, 13.992635],
              zoom: 6,
              pitch: 58,
        ...
        },
        {
            ...
            title: 'نظرة مقارنة',
            image: '',
            description: 'يمكن تفسير هذه الزيادة بانخفاض قيمة الريال في مناطق الحكوم&#1748;<div class="flourish-embed flourish-chart" data-src="visualisation/8574372" style="padding: 0 !important;"></div>',
            location: {
              center: [44.703737, 15.172698],
              zoom: 5.5,
              pitch: 0,
