var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            title: '',
            image: '',
            description: '<h2 class="liftout">لماذا انقسم الاقتصاد؟ الجواب هو أن الحرب اليمنية ليست حرباً عسكرية وسياسية وحسب. إنها صراع اقتصادي أيضاً. صراع قتل فيه من اليمنيين أكثر مما قتل على جبهات القتال.</h2>',
            location: {
              center: [45.731866, 15.500622],
              zoom: 5.30,
              pitch: 0,
        ...
        },
        {
            ...
            title: '',
            image: '',
            description: 'لقد تطور الصراع الاقتصادي على عدة مراحل مختلفة. أولاً، في عام 2016 بعد انهيار محادثات السلام في الكويت، نقلت الحكومة مقر البنك المركزي اليمني من صنعاء التي يسيطر عليها الحوثيون إلى عاصمتها المؤقتة في عدن. اعتقدت الحكومة أن هذا سيعطيها ميزة اقتصادية على الحوثيين. سعت إلى حرمانهم من الوصول إلى احتياطيات البنك بالريال اليمني والعملات الصعبة مثل الدولار، والأكثر أهمية إعادة فرض سيطرتها على التدفقات المالية من وإلى البلاد عبر النظام المصرفي.',
            location: {
        ...
        },
        {
            ...
            title: '',
            image: '',
            description: '<h2 class="liftout">تضافرت هذه الصراعات للسيطرة على الوقود والعملة لتعميق الكارثة الاقتصادية والإنسانية في اليمن وتعميق الانقسامات السياسية. كما أنها أحدثت آثاراً عكسية على الحكومة.</u></h2>',
            location: {
              center: [44.703737, 15.172698],
              zoom: 5.5,
              pitch: 0,
     ...
     onChapterExit: [
       ...
       },
       {
        ...
        },
        {
            ...
            description: 'لا يتعين على هانز غروندبيرغ، مبعوث الأمم المتحدة الجديد إلى اليمن التوسط للتوصل إلى هدنة عسكرية وتسوية سياسية وحسب. بل ينبغي عليه أيضاً أن يتوصل إلى وقف إطلاق نار اقتصادي. لمعرفة المزيد عن الصراع الاقتصادي وكيف يمكن لوقف إطلاق النار الاقتصادي أن يبدو، اقرأ التقرير الجديد لمجموعة الأزمات، "التوسط في وقف إطلاق للنار في الصراع الاقتصادي في اليمن".<p class="footnote">(Image: Yemenis walk past burning tires during protests calling for the removal of the Saudi-backed coalition government and deteriorating economic and living conditions, in Yemen’s third city of Taiz on 27 September 2021. CRISIS GROUP / Ahmad Al-Basha)</p>',
            location: {
              center: [44.703737, 15.172698],
              zoom: 5.5,
              pitch: 0,
